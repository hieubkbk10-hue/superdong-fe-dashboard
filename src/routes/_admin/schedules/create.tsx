    ...
    <div className="space-y-6 max-w-4xl font-sans">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">
              Cấu hình khung giờ chạy cố định theo các ngày trong tuần cho từng tuyến hải trình
            </p>
          </div>
        </div>
      </div>
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              placeholder="VD: SCH-RG-01, SCH-HT-02..."
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              placeholder="VD: Lịch chạy tăng cường phục vụ mùa cao điểm du lịch hè..."
        ...
        <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-end gap-3">
          ...
          >
            <Save size={16} />
            {isSubmitting ? 'Đang lưu...' : 'Lưu Lịch Mới'}
          </button>
        </div>
      </form>
    </div>
