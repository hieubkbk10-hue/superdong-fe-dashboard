...
export const buttonVariants = cva(
  'inline-flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:ring-offset-1 cursor-pointer rounded-xl font-medium transition-all disabled:opacity-50 disabled:pointer-events-none select-none text-xs',
  {
    variants: {
      variant: {
        ...
        success: 'bg-blue-600 text-white hover:bg-blue-700 shadow-xs',
      ...
      size: {
        default: 'h-9 py-1.5 px-3.5',
        xs: 'h-7 text-xs py-0.5 px-2 rounded-lg',
        sm: 'h-8 text-xs py-1 px-3',
        lg: 'h-10 text-sm py-2 px-5 rounded-xl',
